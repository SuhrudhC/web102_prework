...
const descriptionString = `Sea Monster has raised $${totalRaised.toLocaleString()} for ${GAMES_JSON.length} games. Currently, ${unfundedCount} game${unfundedCount !== 1 ? 's' : ''} remain${unfundedCount !== 1 ? '' : 's'} unfunded.`;
